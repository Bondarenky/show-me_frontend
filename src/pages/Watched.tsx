...
import { useGetHistoryQuery } from "../services/videos.service";

const Watched: FC = () => {

    const isAuth = useAuth();
    const {data: watchedVideos, refetch: refetchWatchedVideos} = useGetHistoryQuery("", {
        skip: !isAuth
    })
    ...
    return (
        <div className="flex flex-col gap-12 z-0 py-4">
            ...
            <div className="px-12 flex flex-col gap-12">
                <div>
                    <h3 className="text-3xl text-light-gray font-bold">Переглянуті відео</h3>
                </div>
